...
inquirer
    ...
    if (answers.action === 'Quit') {
        ...
        inquirer.prompt([
            ...
            pool.query('INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ($1, $2, $3, $4)', [employeeInfo.firstName, employeeInfo.lastName, employeeInfo.role, employeeInfo.manager], (err, res) => {
                if (err) {
                    console.error('Error executing query', err.stack);
                }
                else {
